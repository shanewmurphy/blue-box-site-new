  ...
  return (
    <div>
      <div className="w-full bg-myblue lg:h-[80vh] md:h-[85vh] sm:h-svh lg:py-14 lg:px-14 antialiased">
        <div className="xl:w-10/12 lg:w-11/12 md: laptop:w-11/12 sm:w-11/12 mx-auto lg:py-[6%] md:py-[15%] sm:py-[32%]">
          ...
          <div className="lg:hidden md:block md:w-10/12 sm:w-11/12 mx-auto bg-mywhite md:py-6 md:px-2 sm:py-4 sm:px-2 mt-6 rounded-3xl">
            <div className="grid md:grid-cols-2 md:divide-x md:divide-y-0 sm:divide-y sm:px-5 gap-8">
              <div>
