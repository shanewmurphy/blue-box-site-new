...
const Testimonials = [
  {
    id: "01",
    review:
      "I couldn't be happier with the service provided by Blue Box Storage. The pickup service made my move so much easier, and the team was professional and efficient. Highly recommend!",
    name: "Sarah M",
    location: "Cork",
  },
  {
    id: "02",
    review:
      "Blue Box Storage's collection service exceeded my expectations. They arrived right on time, handled everything with care, and made the process seamless. Will definitely use again!",
    name: "John D",
    location: "Cork",
  },
  {
    id: "03",
    review:
      "I highly recommend Blue Box Storage for anyone in need of storage solutions. The 10ft container was spacious enough to fit all my belongings, and the rental process was quick and easy",
    name: "Mark J",
    location: "Cork",
  },
  {
    id: "04",
    review:
      "I was hesitant about using a collection service at first, but Blue Box Storage made it so convenient. From booking to pickup, the process was smooth and stress-free. Thank you for your excellent service!",
    name: "Emma L",
    location: "Cork",
  },
  {
    id: "05",
    review:
      "Blue Box Storage's collection service saved me so much time and effort during my renovation project. Being able to have my belongings collected and stored off-site made the process much smoother. I'm grateful for their excellent service",
    name: "Michael P",
    location: "Cork",
  },
  {
    id: "06",
    review:
      "Moving house is stressful enough, but Blue Box Storage made the storage part a breeze with their collection service. The team was friendly, efficient, and took great care of my belongings. Thank you!",
    name: "Lisa G",
    location: "Cork",
  },
];
      ...
      <div>
        <div className="w-10/12 mx-auto laptop:my-[30%] md:my-[30%] sm:my-[60%]">
          <div className="laotop:w-10/12">
            ...
            <p className="font-medium lg:text-lg md:text-lg sm:text-base text-myblack">
              Blue Box Storage provided excellent service and secure storage.
            </p>
          </div>
          <div className="mt-6">
            <Swiper
