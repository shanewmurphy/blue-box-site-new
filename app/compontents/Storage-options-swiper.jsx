...
export default function StorageOptionsSwiper() {
  return (
    <div>
      <div className="laotop:w-10/12 laptop:my-[30%] md:my-[40%] sm:my-[50%] xl:hidden lg:hidden laptop:visible md:visible sm:visible">
        <h3 className="laptop:text-6xl md:text-5xl sm:text-3xl  text-myblue text-center font-bold mb-1">
          Storage Containers
        </h3>
        <p className="laptop:w-9/12 md:w-10/12 sm:w-11/12 mx-auto text-center font-medium laptop:text-xl md:text-lg sm:text-xs text-myblack">
