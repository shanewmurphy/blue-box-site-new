  ...
  return (
    <div>
      <div className="flex justify-center items-center lg:w-10/12 laptop:w-11/12 md:w-11/12 sm:w-11/12 mx-auto antialiased">
        <div className="w-full lg:h-[70vh] md:h-[40vh] sm:h-[35vh] lg:bg-[url('/Boxes-imgs/Boxes-lg-min.jpg')] md:bg-[url('/Boxes-imgs/Boxes-lg-min.jpg')] sm:bg-[url('/Boxes-imgs/Boxes-sm.jpg')] bg-no-repeat lg:bg-cover md:bg-contain sm:bg-contain flex justify-center items-center">
      ...
      <div className="lg:w-6/12 laptop:w-11/12 md:w-9/12 sm:w-11/12 mb-[30%] mx-auto lg:mt-8 md:mt-3 sm:mt-2">
