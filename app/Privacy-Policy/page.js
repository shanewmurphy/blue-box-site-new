...
export default function PrivacyPolicyPage() {
  return (
    <div>
      ...
      <div className="text-myblack text-medium text-sm lg:w-9/12 mx-auto my-48">
        <h4 className="text-myblue font-semibold text-2xl">Privacy Policy</h4>
        <p className="py-2">Last updated: April 03, 2024</p>
        <p className="py-2">
        ...
        <h4 className="text-myblue font-semibold text-2xl py-2">
          Interpretation and Definitions
        </h4>
        <h5 className="text-myblue text-xl py-2">Interpretation</h5>
        <p className="py-2">
        ...
        <h5 className="text-myblue text-xl py-2">Definitions</h5>
        ...
        <p className="py-2">Country refers to: Ireland</p>
        <p className="py-2">
        ...
        <p className="py-2">Service refers to the Website</p>
        <p className="py-2">
        ...
        <p className="py-2">
          Website refers to Blue Box Storage Cork, accessible from
          www.blueboxstorage.com
        </p>
        <p className="py-2">
        ...
        <h5 className="text-myblue text-xl py-2">Types of Data Collected</h5>
        <h6 className="text-myblue text-lg py-2">Personal Data</h6>
        <p className="py-2">
        ...
        <p className="py-2">First name and last name</p>
        <p className="py-2">Address, Province, ZIP/Postal code, City</p>
        ...
        <h6 className="text-myblue text-lg py-2">
        ...
        <p className="py-2">Necessary / Essential Cookies</p>
        ...
        <p className="py-2">Cookies Policy / Notice Acceptance Cookies</p>
        <p className="py-2">Administered by: Us</p>
        <p className="py-2">
          Purpose: These Cookies identify if users have accepted the use of
          cookies on the Website.
        </p>
        <p className="py-2">Functionality Cookies</p>
        ...
        <h6 className="text-myblue text-lg py-2">Use of Your Personal Data</h6>
        <p className="py-2">
        ...
        <p className="py-2">
          ...
          information may be transferred to â€” and maintained on â€” computers
        ...
        <h6 className="text-myblue text-lg py-2">Delete Your Personal Data</h6>
        <p className="py-2">
        ...
        <p className="py-2 text-myblue">Business Transactions</p>
        <p className="py-2">
        ...
        <p className="py-2 text-myblue">Law enforcement</p>
        <p className="py-2">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <p className="py-2 text-myblue">Other legal requirements</p>
        <p className="py-2">
          The Company may disclose Your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <p className="py-2">Comply with a legal obligation</p>
        <p className="py-2">
        ...
        <p className="py-2">Protect against legal liability</p>
        <h6 className="text-myblue text-lg py-2">
        ...
        <h6 className="text-myblue text-lg py-2">Children&apos;s Privacy</h6>
        <p className="py-2">
        ...
        <h6 className="text-myblue text-lg py-2">Links to Other Websites</h6>
        <p className="py-2">
        ...
        <h6 className="text-myblue text-lg py-2">Contact Us</h6>
        <p className="py-2">
          If you have any questions about this Privacy Policy, You can contact
          us:
        </p>
        <p className="py-2">By email: info@blueboxstorage.com</p>
        <p className="py-2">
          By visiting this page on our website:
          www.blueboxstorage.com/Contact-Us
        </p>
        <p className="py-2">By phone number: 0214 457 457</p>
        <p className="py-2">
          By mail: Units 24-48, Euro Business Park, Little Island, T45 WP96,
          County Cork, Ireland
        </p>
      </div>
      <div>
